...
if(ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE)
  ...
  macro(ANTLR_TARGET Name InputFile)
    ...
    get_filename_component(ANTLR_FOLDER ${InputFile} DIRECTORY)
    ...
    if(ANTLR_TARGET_OUTPUT_DIRECTORY)
      ...
      set(ANTLR_${Name}_OUTPUT_DIR
          #${CMAKE_CURRENT_BINARY_DIR}/antlr4cpp_generated_src/${ANTLR_FOLDER}/${ANTLR_INPUT})
          ${CMAKE_CURRENT_BINARY_DIR}/antlr4cpp_generated_src/${ANTLR_INPUT}/${ANTLR_FOLDER})
    endif()
	#message(FATAL_ERROR ${ANTLR_${Name}_OUTPUT_DIR})
    ...
    add_custom_command(
        ...
        COMMAND ${Java_JAVA_EXECUTABLE} -jar ${ANTLR_EXECUTABLE}
                ${InputFile}
                -o ${CMAKE_CURRENT_BINARY_DIR}/antlr4cpp_generated_src/${ANTLR_INPUT}
                -no-listener
                -Dlanguage=Cpp
